...
export default function Dashboard() {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 overflow-x-hidden">
      <div className="mb-8">
        <h1 className="text-2xl sm:text-4xl font-extrabold text-gray-900 tracking-tight">Painel de Controle</h1>
        ...
        {connectionStatus === 'checking' && (
          <div className="bg-blue-50/50 border border-blue-100 rounded-2xl p-4 backdrop-blur-sm">
            <div className="flex items-center">
              ...
              <p className="text-sm text-blue-800 font-medium">Verificando conexão com Supabase...</p>
            </div>
          </div>
        )}
        {connectionStatus === 'connected' && (
          <div className="bg-green-50/50 border border-green-100 rounded-2xl p-4 backdrop-blur-sm">
            <div className="flex items-center">
              ...
              <p className="text-sm text-green-800 font-semibold">Conectado ao Supabase com sucesso</p>
            </div>
          </div>
        )}
        {connectionStatus === 'error' && (
          <div className="bg-red-50/50 border border-red-100 rounded-2xl p-4 backdrop-blur-sm">
            <div className="flex items-center">
              <div className="w-8 h-8 rounded-full bg-red-100 flex items-center justify-center mr-3">
                <svg className="h-5 w-5 text-red-600" fill="none" viewBox="0 0 24 24" strokeWidth="2.5" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" />
                </svg>
              </div>
              <div>
                <p className="text-sm text-red-800 font-bold">Falha ao conectar ao Supabase</p>
                {errorMessage && <p className="text-xs text-red-700 mt-0.5">{errorMessage}</p>}
              </div>
            </div>
          </div>
        )}
      ...
      {analyticsWarning && !analyticsError && (
        <div className="mb-8 rounded-2xl border border-amber-100 bg-amber-50/50 px-6 py-4 text-sm text-amber-800 font-medium backdrop-blur-sm">
          {analyticsWarning}
        </div>
      )}
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4 mb-10">
        <div className="bg-white overflow-hidden shadow-sm hover:shadow-md transition-shadow border border-gray-100 rounded-2xl">
          <div className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-bold text-gray-500 uppercase tracking-wider">Total de Produtos</dt>
                  <dd className="text-2xl font-black text-gray-900 mt-1">
        ...
        <div className="bg-white overflow-hidden shadow-sm hover:shadow-md transition-shadow border border-gray-100 rounded-2xl">
          <div className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-bold text-gray-500 uppercase tracking-wider">Total de Vendas</dt>
                  <dd className="text-2xl font-black text-gray-900 mt-1">
                    {loading ? '...' : data.totalSales}
                  </dd>
                </dl>
              </div>
            </div>
        ...
        <div className="bg-white overflow-hidden shadow-sm hover:shadow-md transition-shadow border border-gray-100 rounded-2xl">
          <div className="p-6">
            <div className="flex items-center">
              <div className="w-12 h-12 rounded-xl bg-purple-50 flex items-center justify-center text-purple-600 shadow-inner">
                <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-bold text-gray-500 uppercase tracking-wider">Total de Membros</dt>
                  <dd className="text-2xl font-black text-gray-900 mt-1">
        ...
        <div className="bg-white overflow-hidden shadow-sm hover:shadow-md transition-shadow border border-gray-100 rounded-2xl">
          <div className="p-6">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-bold text-gray-500 uppercase tracking-wider">Receita Total</dt>
                  <dd className="text-2xl font-black text-gray-900 mt-1">
