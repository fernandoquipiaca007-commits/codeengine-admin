  ...
  try {
    ...
    const { data, error } = await supabaseAdmin
      ...
      .insert({
        ...
        base_price: formData.is_free ? 0 : (formData.base_price || formData.price || 0),
        base_currency: formData.base_currency || 'USD',
        converted_price: formData.is_free ? 0 : (formData.converted_price || formData.aoa_price || 0),
        exchange_rate_used: formData.exchange_rate_used || 920,
