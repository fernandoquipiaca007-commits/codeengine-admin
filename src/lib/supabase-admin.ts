...
export function handleSupabaseError(error: unknown, context: string): never {
  // Log the full error to the console for developers, but sanitize the message thrown to the UI
  console.error(`[supabase] ${context}:`, error);

  // Return a generic error message to the UI to avoid leaking technical details
