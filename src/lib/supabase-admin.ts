...
/**
 * Singleton for authentication and data operations (anon key + session persistence).
 * Uses Row Level Security (RLS) to protect data.
 */
 ...
 * Always returns the authenticated client to ensure RLS is applied.
 */
