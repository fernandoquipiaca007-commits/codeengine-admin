 ...
 * Enforces Row Level Security (RLS) by using the anon client.
 */
...
/**
 * Sanitizes errors by logging the original but throwing a generic message
 * to avoid leaking technical details to the frontend.
 */
export function handleSupabaseError(error: unknown, context: string): never {
  console.error(`[supabase] ${context}:`, error);
  // Throw a generic message to prevent technical information leakage
