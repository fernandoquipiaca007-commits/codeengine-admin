...
/**
 * Singleton for database/storage operations (using the authenticated anon client).
...
export function handleSupabaseError(error: unknown, context: string): never {
  // Log the original error for debugging, but don't expose it to the user
  console.error(`[supabase] ${context}:`, error);

  // Return a generic error message to prevent leaking database or system internals
