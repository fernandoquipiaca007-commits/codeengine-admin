...
- **All operations in this frontend use the authenticated 'anon' client to enforce RLS.**
- Never include the service role key in this repository as it bypasses all security rules.
