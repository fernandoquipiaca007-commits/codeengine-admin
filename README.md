...
- All data operations are performed using the authenticated anonymous client to enforce RLS
- Never expose service role keys or other administrative secrets in client-side code
